...
- crowdstrike_stackset_role_setup.yml
- crowdstrike_aws_cspm.json (Falcon Gov only)
- crowdstrike_aws_gov_cspm.json (Falcon Gov only)
...
2. Create and save an empty test event. eg. {}
3. Click test. This will invoke the function and force the stacksets to apply the latest template.
